              ...
              <div style={{ maxWidth: 560, margin: "0 auto" }}>
                      ...
                      <div key={q.id}>
                        ...
                        <div style={{
                          ...
                          <div onClick={() => toggleQ(q.id, i)} style={{ padding: "12px 16px", cursor: "pointer", userSelect: "none", display: "flex", alignItems: "flex-start", gap: 10 }}>
                            <span style={{ fontSize: 14, color: isExpanded ? S.accent : "rgba(44,40,36,0.25)", display: "inline-block", flexShrink: 0, marginTop: 1, transform: isExpanded ? "rotate(90deg)" : "rotate(0deg)", transition: `transform 0.25s ${ease}, color 0.2s ease`, fontFamily: "'DM Sans', sans-serif" }}>›</span>
                            <div style={{ flex: 1 }}>
                              ...
                              <div style={{ padding: "12px 16px" }}>
                                ...
                                <div style={{ background: S.recess, borderRadius: 4, border: `1px solid ${S.border}`, boxShadow: "0 1px 2px rgba(0,0,0,0.02) inset", padding: "10px 12px" }}>
                                  <textarea
                                    ...
                                    style={{ width: "100%", background: "transparent", border: "none", fontSize: 13, fontWeight: 400, lineHeight: 1.6, color: S.text, resize: "none", outline: "none", fontFamily: "'DM Sans', sans-serif", overflow: "hidden", minHeight: 40 }}
                                  />
                                  {i < questions.length - 1 && (
                                    <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 4 }}>
                                      <span style={{ fontSize: 9, fontWeight: 500, color: "rgba(44,40,36,0.12)", fontFamily: "'DM Sans', sans-serif" }}>⌘+Enter for next</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                ...
                {answeredCount >= 3 && (
                  <div style={{ marginTop: 24, animation: `fadeIn 0.4s ${ease} both` }}>
                    <button onClick={() => { setLucyMode("thinking"); setTimeout(() => { setPhase("analysis"); setLucyMode("idle"); }, 1500); }} style={{ width: "100%", padding: "12px 0", borderRadius: 6, border: "none", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: S.text, background: `linear-gradient(180deg, #F0ECE5 0%, ${S.card} 100%)`, boxShadow: "0 -1px 0 rgba(0,0,0,0.03), 0 1px 0 rgba(255,255,255,0.6) inset, 0 2px 6px rgba(0,0,0,0.04)", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
            ...
            <div style={{ padding: "8vh 48px 60px", animation: `fadeIn 0.6s ${ease} both` }}>
              <div style={{ maxWidth: 560, margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {GAPS.map((gap, i) => (
                    <div key={i} style={{ background: S.card, borderRadius: 4, border: "1px solid rgba(44,40,36,0.06)", boxShadow: S.raised, padding: "14px 16px", animation: `promptIn 0.4s ${ease} ${i * 0.1}s both` }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                        ...
                        <button onClick={() => goToThemeQuestion(gap.area)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 9, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "rgba(44,40,36,0.25)", padding: "2px 8px", borderRadius: 3, transition: "all 0.15s ease" }}
                          onMouseEnter={(e) => { e.currentTarget.style.color = S.accent; e.currentTarget.style.background = "rgba(229,166,50,0.06)"; }}
                ...
                <div style={{ display: "flex", gap: 0, marginTop: 24, borderRadius: 6, overflow: "hidden", boxShadow: S.raised }}>
                  <button onClick={() => setPhase("questions")} style={{ flex: 1, padding: "12px 0", border: "none", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(44,40,36,0.35)", background: `linear-gradient(180deg, #F0ECE5 0%, ${S.card} 100%)`, borderRight: "1px solid rgba(44,40,36,0.06)", userSelect: "none" }}>BACK TO QUESTIONS</button>
                  <button style={{ flex: 1, padding: "12px 0", border: "none", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: S.text, background: `linear-gradient(180deg, #F0ECE5 0%, ${S.card} 100%)`, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, userSelect: "none" }}>
